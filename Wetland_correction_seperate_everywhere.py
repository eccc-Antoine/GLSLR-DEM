...
def execute(t, cfg, res_folder):
    ...
    if t not in cfg.only_bathy_tiles :
        ...
        dst=os.path.join(dump_folder, f'{t}_1m_dem_wetland_corrected_all.tif')
        dst2=os.path.join(res_folder, f'{t}_1m_dem_wetland_corrected_all.tif')
        merging_rasters(list_tif, dst, gdf_tile, crs, dump_folder)
        
        #change_nodata(dst, dst2, 0, -32768)
        change_nodata(dst, dst2, -32768, 0)
        
        dem_10m=fr'{res_folder}\{t}_10m_dem_wetland_corrected_all.tif'   
...
if __name__ == '__main__':
    ...
    #lot_of_tiles=[198, 202, 202, 205, 211, 211, 211, 211, 225, 251, 262, 273, 273, 273, 285, 292, 295, 346, 357, 406, 436, 436, 441, 457, 466, 483, 483, 483, 491]
    
    lot_of_tiles=[346]
    for tiles in lot_of_tiles:
        tiles=[tiles]
    
        res_folder=fr'F:\DEM_GLAMM\DEM_CREATION_FINAL\results\{tiles[0]}_V4_4'
